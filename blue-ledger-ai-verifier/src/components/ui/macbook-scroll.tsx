...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className=" sticky flex min-h-[150vh] shrink-0 scale-[0.35] transform flex-col items-center justify-start py-0 [perspective:800px] sm:scale-50 md:scale-100 md:py-40"
    ...
    >
      <motion.h2
        ...
        className="text-center text-3xl font-bold text-neutral-800 dark:text-white mb-20"
      >
        {title}
      </motion.h2>
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <img src={src} alt="macbook screen content" className="absolute inset-0 h-full w-full rounded-lg object-cover object-left-top" />
      </motion.div>
    </div>
  );
};
...
const BlueLedgerLogo = () => {
  return (
    <svg width="66" height="65" viewBox="0 0 66 65" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-white">
